...
const company: { label: string; to: string; external?: boolean }[] = [
  ...
  { label: 'Industry Research', to: '/research' },
  { label: 'FAQ', to: '/faq' },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <p className="text-zinc-300 text-base leading-relaxed max-w-[300px]">
              The complete AI-powered Aviation Management System for flight training organisations worldwide — built on ICAO standards, DGCA-ready today, EASA and FAA in development. Built by pilots, for pilots.
            </p>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 md:px-6 mt-12 md:mt-16 pt-6 pb-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
            ...
            <span className="w-1.5 h-1.5 rounded-full bg-cyan-500" />
            <span className="text-zinc-400 text-xs md:text-sm font-medium">ICAO Standards-Based</span>
            <span className="w-1.5 h-1.5 rounded-full bg-cyan-500" />
